...
namespace QuickTime
{
	...
	class CampaignTimePatches
	{
		...
		private const long MsecPerSecL    = 1000L;
		private const long SecPerMinL     = 60L;
		private const long MinPerHourL    = 60L;
		private const long HourPerDayL    = 24L;
		private const long DayPerWeekL    = 3L;
